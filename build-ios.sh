#!/bin/sh
echo "编译opencore-amr for iOS8并支持bitcode"
echo "http://blog.csdn.net/devday/article/details/49357289"
...
IOSV="-miphoneos-version-min=8.0"
if [ $arch == "arm64" ]
then
IOSV="-miphoneos-version-min=8.0"
fi
...
;;
*)
IOSV="-mios-simulator-version-min=8.0"
echo "Building for iOS $arch*****************"
